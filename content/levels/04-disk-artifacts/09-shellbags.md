...
- **Removable media** — including volume identifiers, pairing with [USB device history](#/lesson/l4-08-registry-hives)
...
- **Paths that no longer exist**, corroborated against [USN journal](#/lesson/l4-06-usn-journal) deletion entries.
