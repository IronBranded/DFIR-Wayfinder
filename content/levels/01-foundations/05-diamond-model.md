...
**Victim → Infrastructure.** What did the compromised host connect to? [Proxy logs, DNS, NetFlow](#/lesson/l7-02-proxy-firewall-triage).
...
**Capability → Adversary.** Who is known to use this tooling? [Mutex names](#/lesson/l5-07-mutex-analysis) and [C2 fingerprints](#/lesson/l7-09-c2-framework-fingerprinting) both pivot here.
