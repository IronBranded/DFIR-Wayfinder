...
Seeing all three in sequence is a subscription being installed, start to finish — which is why [Sysmon deployment](#/lesson/l1-12-sysmon-deployment) meaningfully changes what is detectable here.
