...
That is the practical takeaway: an environment monitoring process creation but not image loads is effectively blind to this whole class, which is a point worth revisiting in [the Sysmon deployment lesson](#/lesson/l1-12-sysmon-deployment).
