...
> [!TIP]
> Prefetch answers "did it run, from where, how often." [Amcache](#/lesson/l2-04-amcache) answers "was it here, and what was its hash." [ShimCache](#/lesson/l2-05-shimcache) answers something weaker than either. Reading all three and reconciling their disagreements is the actual technique.
