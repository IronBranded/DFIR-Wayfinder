...
> [!TIP]
> [The next lesson](#/lesson/l3-09-lsass-memory-analysis) returns to a technique this whole academy keeps coming back to from different angles: credential theft from LSASS, this time read directly from the memory image itself.
