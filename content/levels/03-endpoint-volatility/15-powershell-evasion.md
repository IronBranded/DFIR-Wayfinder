...
> [!TIP]
> Whatever evasion technique produced the script block, [the previous lesson](#/lesson/l3-14-powershell-obfuscation) is what actually gets you from an unreadable payload to readable text once you have it in hand.
