...
> [!WARNING]
> Every technique above eventually has to create or redirect an actual thread to run. [The next lesson](#/lesson/l3-07-thread-analysis) covers reading thread state directly — often a cleaner signal than any of the process-level artifacts these techniques leave behind.
