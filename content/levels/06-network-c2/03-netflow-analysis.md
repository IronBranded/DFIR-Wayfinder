...
**Beaconing detection.** Inter-arrival regularity and consistent transfer sizes, the same analysis as [proxy triage](#/lesson/l6-02-proxy-firewall-triage), applied to flows.
