...
| Remediation | [krbtgt double reset](#/lesson/l4-04-krbtgt-double-reset) | Reset that service account |
...
> [!IMPORTANT]
> A confirmed Golden Ticket cannot be remediated by resetting user passwords, disabling accounts, or rebuilding endpoints. The forged ticket remains valid until the krbtgt key it was signed with is invalidated — which is exactly the [double reset](#/lesson/l4-04-krbtgt-double-reset) covered next.
