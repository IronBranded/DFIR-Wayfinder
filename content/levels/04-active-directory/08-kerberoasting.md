...
> [!TIP]
> A cracked service account password is rarely the endpoint. It's a credential — which usually leads into [Pass-the-Hash / Pass-the-Ticket](#/lesson/l4-11-pass-the-hash-pass-the-ticket), or, if the account turns out to be privileged enough, straight to [DCSync](#/lesson/l4-05-dcsync-detection).
