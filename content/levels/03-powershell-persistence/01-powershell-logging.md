...
> [!TIP]
> This lesson tells you where the evidence lives. The [next lesson](#/lesson/l3-02-powershell-obfuscation) covers what to do with it once you have it — reading a 4104 script block that's still obfuscated even after PowerShell's own parser has touched it.
