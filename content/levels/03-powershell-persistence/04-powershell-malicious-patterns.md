...
> [!TIP]
> This closes out PowerShell Forensics as a set. The [Endpoint Persistence](#/lesson/l3-05-registry-run-keys) module that follows covers what an attacker who's successfully executed code does next to make sure a reboot doesn't undo their work.
