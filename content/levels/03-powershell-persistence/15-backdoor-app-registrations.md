[The previous lesson](#/lesson/l3-14-oauth-consent-grants) covered an attacker persuading a user to authorize an application. This one covers the version that needs no user at all: an application identity in the tenant, holding its own credentials, acting as itself.
