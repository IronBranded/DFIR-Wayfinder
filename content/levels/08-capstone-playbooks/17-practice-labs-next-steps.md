...
2. **Work a CyberDefenders or Digital Corpora scenario end to end**, writing it up the way [Reporting & Communication](#/lesson/l1-10-reporting-communication) describes — both the technical and executive versions — not just reaching an answer privately.
