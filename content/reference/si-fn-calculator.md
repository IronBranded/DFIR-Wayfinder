...
The full reasoning behind these rules lives in [Level 2's $MFT & Timestomping lesson](#/lesson/l2-02-mft-timestomping) — this page exists to make that table interactive rather than something to re-derive by hand mid-investigation.
