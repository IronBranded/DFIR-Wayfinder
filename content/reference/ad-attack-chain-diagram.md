# AD Attack Chain Diagram

The full reasoning behind each stage lives in [Level 4's capstone lesson](#/lesson/l4-14-ad-attack-chain-overview) — this page exists for quick reference mid-investigation, without needing to reopen the full lesson.
